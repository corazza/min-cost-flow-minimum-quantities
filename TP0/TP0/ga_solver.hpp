...
struct SolverParameters {
    ...
    int flow_value;
    int best_of;
    int improvements_stop;
};

NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(SolverParameters, num_perturbations, generation_size, num_steps, flow_value, best_of, improvements_stop);
